...
export function GardenTab({ addGardenArea, assignPlantToAreaSlot, careLog, clearAreaSlot, deleteGardenArea, fertilizerTrackers, gardenAreas, gardenFocusAreaId, gardenY, harvestTrackers, onAutoOptimize, onFocusConflict, onSavePlant, openPlantFromList, pickAreaPhoto, renameGardenArea, savedPlants, scheduleFertilizerReminder, setAreaStyle, setCareLog, showUndoToast, theme, unitSystem, waterArea, wateredPlants, weather, zip, zone }) {
