...
export default {
  ...
  calendarExport: {
    ...
    waterTask: "🌿 Water the garden",

    fertilizeTask: "🌾 Fertilize the garden",

    pestsTask: "🐛 Check for pests",

    every2Days: "Every 2 days",

    every3Days: "Every 3 days",

    accessNeededBody: "Allow calendar access to add the reminder, or use “Share as .ics file” instead.",

    noCalendarBody: "Couldn't find a calendar to write to. Try the .ics file export instead.",

    addedByApp: "Added by Pocket Planter 🌿",

    addedTitle: "Added to calendar ✅",

    addFailedTitle: "Couldn't add event",

    addFailedBody: "Something went wrong. Try the .ics file export instead.",

    heading: "📅 ADD TO CALENDAR",

    blurb: "Put a recurring garden reminder on your real calendar.",

    addToDevice: "Add to device calendar",

    shareIcs: "Share as .ics file",

    footnote: "Reminders start at 8:00 AM. The .ics file works with any calendar app.",
