...
export default {
  ...
  notify: {
    ...
    offBody: "Turn on notifications for Pocket Planter in your phone's Settings to get watering, frost, and harvest reminders.",
    promptTitle: "Stay on top of your garden 🌱",
    promptBody: "Pocket Planter can remind you when to water, warn you before frost or heat, and tell you when plants are ready to harvest. Turn on notifications?",
  ...
  garden: {
    ...
    noBedsTitle: "No open beds yet",
    noBedsBody: "Add a garden bed first, then you can drop plants into it. Set one up in the Garden tab.",
    ...
    gardenCareTracker: "🧪 Garden Care Tracker",
    closeGardenCareTracker: "✕ Close Garden Care Tracker",
    ...
    conflicts: "🔴 Conflicts",
    fertilizerIntelligence: "🌿 Fertilizer Intelligence",
  ...
  journal: {
    ...
    emptyBody: "Snap a photo whenever something changes. In a few weeks you'll have a beautiful timeline of your garden growing from seed to harvest — with progress bars, streaks, and badges along the way.",
    ...
    photosThisWeek: { one: "🔥 {count} photo this week — you're on a roll!", other: "🔥 {count} photos this week — you're on a roll!" },
  ...
  empty: {
    ...
    nothingOverdueBody: "Just tomorrow's watering on deck.",
    loading: "Loading…",
  },
  ...
  gardenPlannerMap: {
    greatPair: "Great pair ✓",
    conflict: "Conflict ⚠",
    needsWater: "Needs water 💧",
    empty: "Empty ＋",
    plotsFilled: "Plots filled",
    greatPairs: "Great pairs",
    excellentPair: "Excellent Pair",
    plantNow: "Plant now",
    change: "Change →",
    season: "Season:",
    ...
    readyToHarvest: "🎉 Ready to harvest!",
    greatPairsNearby: "🟢 Great pairs nearby:",
    conflictsInYourGarden: "🔴 Conflicts in your garden:",
    removeFromPlot: "🗑 Remove from plot",
    tapAnyPlotToPlace: "Tap any plot to place a plant",
    pocketPlanterWillShowCompanion: "Pocket Planter will show companion pairing, watering status, harvest countdowns, and weather alerts for each plot.",
  },
  ...
  weeklyAndTasks: {
    ...
    yourGardenProgress: "Your Garden Progress 🌱",
    watered: "💧 Watered:",
    photos: "📸 Photos:",
    saved: "🪴 Saved:",
    xp: "⭐ XP:",
    ...
    startYourGardenStory: "Start your garden story",
    saveYourFirstPlantLog: "Save your first plant, log a photo, or mark something as watered — your recap will appear here.",
    waterAPlant: "💧 Water a plant",
    addAPhoto: "📸 Add a photo",
    saveAPlant: "🌱 Save a plant",
  ...
  gardenAreaManager: {
    hideGardenMaps: "Hide Garden Maps",
    viewGardenMaps: "🗂️ View Garden Maps",
    hangingPlanter: "Hanging Planter",
    hangingPlanter1Plant: "+ Hanging Planter (1 plant)",
  ...
  profile: {
    ...
    gardenerProfile2: "🧑‍🌾 Gardener Profile",
  ...
  weatherTask: {
    smartTasks: "SMART TASKS",
    weatherbasedTasks: "Weather-Based Tasks",
  },
  ...
  gardenHealth: {
    gardenCompatibilityScore: "Garden Compatibility Score",
    companionBalance: "🌱 Companion balance",
    waterBalance: "💧 Water balance",
    sunMatch: "☀️ Sun match",
    zoneFit: "📍 Zone fit",
    noMajorCompanionConflictsFound: "No major companion conflicts found.",
  },
  ...
  cropRotation: {
    ...
    rotateToProtectYourSoil: "Rotate to Protect Your Soil",
    theSamePlantFamilyAs: "the same plant family as a past year. Rotating families each season helps avoid soilborne disease and pest buildup.",
    grewHereIn: "grew here in",
    tryADifferentFamilyThis: "— try a different family this season",
    goodRotationsFollowLegumesWith: "Good rotations: follow legumes with leafy greens, brassicas with roots, nightshades with legumes.",
  },
  ...
  todaysGamePlan: {
    todaysGamePlan: "TODAY'S GAME PLAN",
    youreAllCaughtUp: "You're all caught up! 🌿",
    nothingUrgentInTheGarden: "Nothing urgent in the garden right now. Check back tomorrow, or browse new plants to grow.",
  },

  trends: {
    logWateringsPhotosAndHarvests: "Log waterings, photos, and harvests and your season trends will chart here month by month.",
    yourLast6MonthsOf: "Your last 6 months of garden activity at a glance.",
    waterings: "💧 WATERINGS",
    photos: "📸 PHOTOS",
    harvests: "🚜 HARVESTS",
  },
  ...
  yieldTracker: {
    logHarvestsFromAPlants: "Log harvests (from a plant's page or the Harvest Log) and this card will track your yields and compare them season over season.",
    harvestsIn: "Harvests in",
    vsLastYear: "% vs last year (",
    keepLoggingNextYearYoull: "Keep logging — next year you'll see a season-over-season comparison here.",
  ...
  plantingGuide: {
    ...
    generalGuidanceFor: "General guidance for",
    checkYourSeedPacketFor: ". Check your seed packet for variety-specific details.",
  },
  ...
  swipeablePlantGallery: {
    noPlantsForYourZone: "No plants for your zone yet",
    setYourZipCodeOn: "Set your ZIP code on the Home tab to see plants matched to your growing zone.",
    previous: "‹ Previous",
    next: "Next ›",
  },
  ...
  smartReminderHome: {
    smartReminders: "Smart Reminders",
    allGardenRemindersAreActive: "All garden reminders are active",
    tapToFinishSettingUp: "Tap to finish setting up reminders",
  },

  xP: {
    gardenProgression: "Garden progression",
    totalXpEarnedFromGardening: "total XP earned from gardening activity.",
  ...
  seasonComparison: {
    nothingLoggedThis: "Nothing logged this",
    yetWaterAPlantAdd: "yet. Water a plant, add a photo, or log a harvest and it'll show up here. 🌱",
  },

  streakProgress: {
    dayGardenStreak: "-day garden streak",
    keepOpeningPocketPlanterTo: "Keep opening Pocket Planter to reach your next 7-day reward.",
  },
  ...
  intro: {
    ...
    zoneTitle: "Plants matched to your zone",
    zoneBody: "See exactly what grows where you live, and the best month to plant each one.",
    waterTitle: "Smart watering & weather",
    waterBody: "Daily reminders, frost warnings, and heat alerts tuned to your local forecast.",
    planTitle: "Plan your garden",
    planBody: "Lay out beds, check companion pairings, and track every plant in one place.",
    journalTitle: "Journal your progress",
    journalBody: "Photo timelines, harvest logs, and season stats that show how far you've come.",
    growTitle: "Earn as you grow",
    growBody: "XP, streaks, badges, and daily quests keep your garden habit going.",
