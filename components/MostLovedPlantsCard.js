        ...
        {ranked.map((entry, i) => {
          ...
          return (
            <Pressable
              ...
              style={{ flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "rgba(255, 255, 255, 0.06)", borderRadius: 16, padding: 12, borderWidth: 1, borderColor: "rgba(107, 199, 255, 0.16)" }}
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ color: theme.text, fontSize: 14, fontWeight: "900" }}>{entry.name}</Text>
                <Text style={{ color: "#6bc7ff", fontSize: 12, fontWeight: "800", marginTop: 2 }}>
                  {t("mostLovedPlants.watered")} {entry.count} time{entry.count === 1 ? "" : "s"}
                </Text>
              </View>
