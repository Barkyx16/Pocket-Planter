...
const ACCENTS = {
  green: { solid: "#5cff89", soft: "rgba(92,255,137,0.10)", text: "#8effab", border: "rgba(92,255,137,0.24)" },
  blue: { solid: "#6bc7ff", soft: "rgba(107,199,255,0.10)", text: "#6bc7ff", border: "rgba(107,199,255,0.24)" },
  ...
  return (
    <>
      <Pressable
        ...
        style={{ marginTop, backgroundColor: open ? c.soft : c.solid, borderRadius: 14, paddingVertical: 13, alignItems: "center", borderWidth: open ? 1 : 0, borderColor: c.border }}
      >
