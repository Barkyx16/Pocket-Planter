  ...
  return (
    <View style={{ borderRadius: 24, padding: 18, marginBottom: 18, borderWidth: 1.5, backgroundColor: `${accent}12`, borderColor: accent }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ color: accent, fontSize: 12, fontWeight: "900", letterSpacing: 0.5 }}>{t("wateringStreakNudge.dontBreakYourStreak")}</Text>
      ...
      <Text style={{ color: theme.secondaryText, fontSize: 12, fontWeight: "700", lineHeight: 19, marginTop: 8 }}>
        {t("wateringStreakNudge.thesePlantsHaveAWatering")}
      </Text>
          ...
          return (
            <View
              ...
              style={{
                ...
                backgroundColor: "rgba(255, 255, 255, 0.06)", borderRadius: 16, padding: 12,
