...
export const styles = StyleSheet.create({
  ...
  liveWeatherBody: { marginTop: 6, color: "#d7ebdc", fontSize: 13, lineHeight: 19, fontWeight: "700" },
 liveWeatherGrid: { flexDirection: "row", gap: 8, marginTop: 14 },
  liveWeatherBox: { flex: 1, borderRadius: 14, paddingVertical: 11, paddingHorizontal: 4, alignItems: "center", backgroundColor: "rgba(255,255,255,0.07)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  liveWeatherIcon: { fontSize: 18 },
  liveWeatherLabel: { marginTop: 5, color: "#d7ebdc", fontSize: 10.5, fontWeight: "800" },
  liveWeatherValue: { marginTop: 3, color: "#ffffff", fontSize: 19, fontWeight: "900" },
  liveWeatherFooter: { marginTop: 12, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.08)", paddingTop: 10 },
  liveWeatherFooterText: { color: "#bfe8ca", fontSize: 12, fontWeight: "700" },
  ...
  detailMiniCard: { flexDirection: "row", alignItems: "flex-start", gap: 12, backgroundColor: "rgba(255,255,255,0.07)", borderRadius: 14, paddingVertical: 11, paddingHorizontal: 13, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  detailMiniIcon: { fontSize: 19, marginTop: 1 },
  detailMiniLabel: { color: "#8effab", fontWeight: "900", fontSize: 10.5, letterSpacing: 0.3, textTransform: "uppercase" },
  detailMiniValue: { marginTop: 3, color: "#ffffff", fontSize: 13, lineHeight: 18, fontWeight: "700" },
  detailControlGrid: { flexDirection: "row", gap: 8, marginTop: 10 },
  controlTile: { flex: 1, borderRadius: 14, paddingVertical: 11, alignItems: "center", backgroundColor: "rgba(255,255,255,0.07)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  controlTileActive: { backgroundColor: "#5cff89", borderColor: "#5cff89" },
  controlTileIcon: { fontSize: 20 },
  controlTileTitle: { marginTop: 5, color: "#ffffff", fontWeight: "900", fontSize: 11.5, textAlign: "center" },
  ...
  stepNumber: { width: 26, height: 26, borderRadius: 13, backgroundColor: "#5cff89", alignItems: "center", justifyContent: "center" },
  stepNumberText: { color: "#07120b", fontWeight: "900", fontSize: 13 },
  stepText: { flex: 1, color: "#ffffff", lineHeight: 20, fontWeight: "700", fontSize: 13.5, paddingBottom: 12 },
  companionSectionTitle: { color: "#ffffff", fontSize: 15, fontWeight: "900" },
  companionChip: { flexDirection: "row", alignItems: "center", gap: 8, width: "48%", backgroundColor: "rgba(92,255,137,0.10)", borderWidth: 1, borderColor: "rgba(92,255,137,0.28)", borderRadius: 12, paddingVertical: 7, paddingHorizontal: 9 },
  companionChipIconWrap: { width: 34, height: 34, borderRadius: 10, backgroundColor: "rgba(92,255,137,0.16)", alignItems: "center", justifyContent: "center" },
  companionChipName: { flex: 1, color: "#ffffff", fontSize: 13, fontWeight: "800" },
  ...
  bottomTabs: { position: "absolute", left: 6, right: 6, bottom: 16, flexDirection: "row", backgroundColor: "rgba(10,18,14,0.88)", borderRadius: 28, padding: 3, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", shadowColor: "#000", shadowOpacity: 0.28, shadowRadius: 24, shadowOffset: { width: 0, height: 14 }, elevation: 22 },
  bottomTabButton: { flex: 1, flexDirection: "column", alignItems: "center", justifyContent: "center", paddingVertical: 7, paddingHorizontal: 1, borderRadius: 20 },
  bottomTabButtonActive: { backgroundColor: "#5cff89", borderRadius: 18, shadowColor: "#5cff89", shadowOpacity: 0.45, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 12 },
  bottomTabText: {
  marginTop: 2,
  fontSize: 8,
  fontWeight: "900",
 ...
 weatherWarningBanner: { flexDirection: "row", alignItems: "center", gap: 14, borderRadius: 26, padding: 18, marginBottom: 18, borderWidth: 1 },
  ...
  harvestTrackerCard: { flexDirection: "row", alignItems: "center", gap: 11, backgroundColor: "rgba(92,255,137,0.10)", borderRadius: 14, padding: 11, marginTop: 10, borderWidth: 1, borderColor: "rgba(92,255,137,0.24)" },
  ...
  harvestTrackerButton: { backgroundColor: "#5cff89", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 9 },
...
journalEmptyIconRing: {
  ...
  backgroundColor: "rgba(92,255,137,0.10)",
  borderWidth: 1.5,
  borderColor: "rgba(92,255,137,0.35)",
  marginBottom: 16,
  shadowColor: "#5cff89",
  shadowOpacity: 0.5,
  shadowRadius: 24,
