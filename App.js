  ...
  if (selectedPlant) {
    return (
      <PlantDetailScreen
        ...
        openPest={openPest}
        openPlantByName={openPlantByName}
        pickJournalPhoto={pickJournalPhoto}
        placeFromPlacementPrompt={placeFromPlacementPrompt}
        plantNotes={plantNotes}
        premiumUnlocked={premiumUnlocked}
        quickAddPlantToGarden={quickAddPlantToGarden}
        rarityStyle={rarityStyle}
        replaceFromPlacementPrompt={replaceFromPlacementPrompt}
        resolveCompanionPlant={resolveCompanionPlant}
        savedPlants={savedPlants}
        schedulePlantReminder={schedulePlantReminder}
        selectedPlant={selectedPlant}
        setGardenPlacementPrompt={setGardenPlacementPrompt}
        setHarvestLogPlant={setHarvestLogPlant}
        setHarvestLogText={setHarvestLogText}
        setHarvestTrackers={setHarvestTrackers}
        setPlantNotes={setPlantNotes}
        showLevelUp={showLevelUp}
        theme={theme}
        toggleFertilizerTracker={toggleFertilizerTracker}
